...
public class CardTester {
	...
	public static void main(String[] args) {
			...
			ArrayList<Card> sextet1 = new ArrayList<Card>(6);
			ArrayList<Card> sextet2 = new ArrayList<Card>(6);
			ArrayList<Card> sextet3 = new ArrayList<Card>(6);
			ArrayList<Card> sextet4 = new ArrayList<Card>(6);
			ArrayList<Card> sextet5 = new ArrayList<Card>(6);
			ArrayList<Card> sextet6 = new ArrayList<Card>(6);
			ArrayList<Card> sextet7 = new ArrayList<Card>(6);
			ArrayList<Card> sextet8 = new ArrayList<Card>(6);
			ArrayList<Card> sextet9 = new ArrayList<Card>(6);
			ArrayList<Card> sextet10 = new ArrayList<Card>(6);
			ArrayList<Card> sextet11 = new ArrayList<Card>(6);
			ArrayList<Card> sextet12 = new ArrayList<Card>(6);
			ArrayList<Card> sextet13 = new ArrayList<Card>(6);
			ArrayList<Card> sextet14 = new ArrayList<Card>(6);
			ArrayList<Card> sextet15 = new ArrayList<Card>(6);
			ArrayList<Card> sextet16 = new ArrayList<Card>(6);
